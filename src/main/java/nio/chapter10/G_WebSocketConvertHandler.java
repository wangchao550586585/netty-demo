 ...
 * 代码清单 10-7 使用 MessageToMessageCodec
 。通过使用MessageToMessageCodec，我们可以在一个单个的
 类中实现该转换的往返过程。
 */
@ChannelHandler.Sharable
public class G_WebSocketConvertHandler extends MessageToMessageCodec<WebSocketFrame, G_WebSocketConvertHandler.MyWebSocketFrame> {
